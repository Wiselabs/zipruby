...
rdoc -w 4 -SHN -m README.md README.md zipruby.c LICENSE.libzip ChangeLog --title 'Zip/Ruby - Ruby bindings for libzip.'
mkdir work
cp -r *?[!work] work 2> /dev/null
cd work
tar jcf zipruby-${VERSION}.tar.bz2 --exclude=.git README.md *.gemspec ext doc
